...
| caching.maxItemsCount         | no        | 0 (unlimited)      | Max number of cache entries (responses) to be kept in cache. Default (0): unlimited. Useful on systems with limited amount of RAM. |
...
| caching.prefetchMaxItemsCount | no        | 0 (unlimited)      | Max number of domains to be kept in cache for prefetching. Default (0): unlimited. Useful on systems with limited amount of RAM. |
